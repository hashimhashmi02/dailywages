      ...
      <aside className="hidden lg:flex flex-col w-64 bg-slate-900 text-white min-h-screen sticky top-0">
        ...
        <div className="mt-auto p-6 border-t border-slate-800">
          <div className="flex items-center gap-3 mb-4">
            <div className="w-10 h-10 rounded-xl bg-slate-700 flex items-center justify-center text-sm font-bold">AD</div>
            <div>
      ...
      <main className="flex-1 lg:pt-0 pt-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-6">
          <div className="flex items-center justify-between mb-6">
            ...
            <div className="hidden sm:flex items-center gap-2 text-xs text-muted-foreground bg-white px-4 py-2 rounded-xl border border-border">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-3 gap-4 mb-6">
            {KPI_CARDS.map((kpi) => (
              <div key={kpi.label} className="bg-white rounded-2xl p-5 border border-border hover-lift">
                ...
                {stats.weeklyRevenue.map((d) => {
                  ...
                  return (
                    <div key={d.day} className="flex-1 flex flex-col items-center gap-1">
                      <span className="text-[10px] text-muted-foreground">₹{(d.revenue / 1000).toFixed(0)}k</span>
                      <div
                        className="w-full gradient-primary rounded-t-lg transition-all hover:opacity-80 cursor-pointer"
          ...
          <div className="mt-6 grid sm:grid-cols-3 gap-4">
            <Link href="/admin/workers" className="bg-white rounded-2xl p-5 border border-border hover-lift flex items-center gap-4">
            ...
            <Link href="/admin/disputes" className="bg-white rounded-2xl p-5 border border-border hover-lift flex items-center gap-4">
            ...
            <Link href="/admin/revenue" className="bg-white rounded-2xl p-5 border border-border hover-lift flex items-center gap-4">
